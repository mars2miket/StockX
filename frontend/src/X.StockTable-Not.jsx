...
>
        ...
        <tbody>
          {filteredRows.length === 0 ? (
            <tr>
              <td colSpan={12} style={{ padding: '48px', textAlign: 'center', color: theme.textMuted }}>
...
// Inside the filteredRows.map loop inside the <tbody>:
                ...
                >
                  ...
                  >
                    {s.obi != null ? (s.obi > 0 ? '+' : '') + s.obi.toFixed(2) : '—'}
                  </td>
                    ...
                    {SIGNAL_BADGE[s.signalStatus] ? (
                      <span
                        style={{
                          ...
                          fontWeight: 600,
                          fontSize: '11px',
                          color: s.signalStatus === 'BUY' ? theme.accent : theme.accentDanger,
                          background: s.signalStatus === 'BUY' ? theme.accent + '22' : theme.accentDanger + '22',
                        }}
                      >
                        {SIGNAL_BADGE[s.signalStatus].label}
                      </span>
                    ) : (
                  ...
                  >
                    {s.executeTarget != null ? `$${s.executeTarget}` : '—'}
                  </td>
                  ...
                  >
                    {s.urgencyDecay != null ? `${s.urgencyDecay}s` : '—'}
                  </td>

                  {/* News */}
                  <td style={{ padding: '6px 10px', fontSize: '13px', whiteSpace: 'nowrap', overflow: 'hidden', borderBottom: `1px solid ${theme.border}` }}>
                    {s.headline ? (
                      <span>
                        <a
                          href={s.articleUrl}
